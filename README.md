...
- **ビルドツール**：Vite
- **スタイリング**：Tailwind CSS
- **オーディオ**：Howler.js（メカニカルキーボード音の再生）
...
入力時に再生される本物のメカニカルキーボード音：

- **Holy Panda スイッチ**：人気のタクタイルスイッチの打鍵音（2バリエーション）
- **Topre スイッチ**：高品質な静電容量無接点スイッチの打鍵音
- **ランダム再生**：3種類の音をランダムに再生し、自然な打鍵感を演出
