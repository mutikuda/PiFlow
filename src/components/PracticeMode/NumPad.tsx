      ...
      <div className="grid grid-cols-3 gap-2">
        {buttons.slice(0, 9).map((digit, index) => (
          <button
            ...
            disabled={disabled}
            className={`
              group relative h-14 sm:h-16 rounded-lg text-xl sm:text-2xl font-bold font-mono-custom
        ...
        <div className="col-start-2">
          <button
            ...
            disabled={disabled}
            className={`
              group relative w-full h-14 sm:h-16 rounded-lg text-xl sm:text-2xl font-bold font-mono-custom
              transition-all duration-200 transform
              bg-gradient-to-br from-gray-800 to-gray-900
              border border-blue-500/30
              shadow-lg hover:shadow-2xl
